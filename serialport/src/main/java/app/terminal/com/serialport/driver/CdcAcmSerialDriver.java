...
package app.terminal.com.serialport.driver;
...
public class CdcAcmSerialDriver implements UsbSerialDriver {
    ...
    class CdcAcmSerialPort extends CommonUsbSerialPort {
        ...
        public void open(UsbDeviceConnection connection) throws IOException {
            ...
            try {
                ...
                Log.d(TAG, "Control endpoint direction: " + mControlEndpoint.getType());
                ...
                Log.d(TAG, "Read endpoint direction: " + mReadEndpoint.getType());
                mWriteEndpoint = mDataInterface.getEndpoint(0);
                Log.d(TAG, "Write endpoint direction: " + mWriteEndpoint.getDirection());
                Log.d(TAG, "Write endpoint direction: " + mWriteEndpoint.getType());
        ...
        @Override
        public int read(byte[] dest, int timeoutMillis,boolean isOpenAsyncRead) throws IOException {
            if (mEnableAsyncReads && isOpenAsyncRead) {
    ...
    public static Map<Integer, int[]> getSupportedDevices() {
        ...
        //联星技术读卡器
        supportedDevices.put(Integer.valueOf(UsbId.VENDOR_LINKSILLICON_VENDOR_ID), new int[]{
                UsbId.VENDOR_LINKSILLICON_PRODUCT_ID,
        });
